...
public class Pointer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (randomDeviation)
        {
            hitscan.direction = Quaternion.Euler(Player.transform.eulerAngles + new Vector3(-Random.Range(-deviation.y + 0.4f, deviation.y), Random.Range(-deviation.x, deviation.x), 0)) * Vector3.forward;
        }
        else if (fixedDeviation)
        {
            ...
            hitscan.direction = Quaternion.Euler(Player.transform.eulerAngles + new Vector3(-deviationY + 0.4f, deviationX, 0)) * Vector3.forward;
        }
        else
        {
            hitscan.direction = Quaternion.Euler(Player.transform.eulerAngles + new Vector3(-deviation.y + 0.4f, deviation.x, 0)) * Vector3.forward;
        }
