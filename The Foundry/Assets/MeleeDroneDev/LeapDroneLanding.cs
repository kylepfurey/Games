...
//WARNING
//This script is duplicated from the LeapDroneAggro. There were problems pertaining to lookat since landing should keep the orinetation
public class LeapDroneLanding : LeapDroneStateTemplate
{
