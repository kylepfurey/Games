...
public class Kart1Light : MonoBehaviour
{
    public Kart1 Kart;
        ...
        if (Kart.start)
        {
            ...
            if (LIGHT && lightUp)
            {
                if (LightOn)
                {
                    ...
                    Kart.KartSettings.Audio.Play("Light Off");
                }
                else
                {
                    LightOn = true;

                    Kart.KartSettings.Audio.Play("Light On");
                }
            ...
            if (BEEP && beepUp == true)
            {
                ...
                Kart.KartSettings.Audio.StartSound("Beep 1", 0);
            }
            ...
            if (BEEP == false)
            {
                ...
                Kart.KartSettings.Audio.StopSound("Beep 1");
            }
        }
    }
