...
public class Kart3HUD : MonoBehaviour
{
    // Kart Reference
    public Kart3 Kart;
    ...
    void Start()
    {
        GameObject Object0 = GameObject.FindWithTag("Kart3");
        Kart = Object0.GetComponent<Kart3>();
    }
    ...
    void FixedUpdate()
    {
        ...
        foreach (Transform child in transform)
        {
            ...
            {
                child2.gameObject.layer = LayerMask.NameToLayer("Kart3");

                foreach (Transform child3 in child2.transform)
                {
                    child3.gameObject.layer = LayerMask.NameToLayer("Kart3");

                    foreach (Transform child4 in child3.transform)
                    {
                        child4.gameObject.layer = LayerMask.NameToLayer("Kart3");
                    }
                }
            }
        }

        ShellAim.layer = LayerMask.NameToLayer("Kart3");
