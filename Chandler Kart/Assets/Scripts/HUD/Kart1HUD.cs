...
public class Kart1HUD : MonoBehaviour
{
    // Kart Reference
    public Kart1 Kart;
    ...
    void Start()
    {
        ...
        Kart = Object0.GetComponent<Kart1>();
    }
    ...
    void FixedUpdate()
    {
        ...
        foreach (Transform child in transform)
        {
            ...
            {
                child2.gameObject.layer = LayerMask.NameToLayer("Kart1");

                foreach (Transform child3 in child2.transform)
                {
                    child3.gameObject.layer = LayerMask.NameToLayer("Kart1");

                    foreach (Transform child4 in child3.transform)
                    {
                        child4.gameObject.layer = LayerMask.NameToLayer("Kart1");
                    }
                }
            }
        }

        ShellAim.layer = LayerMask.NameToLayer("Kart1");
