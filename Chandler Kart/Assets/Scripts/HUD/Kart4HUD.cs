...
public class Kart4HUD : MonoBehaviour
{
    // Kart Reference
    public Kart4 Kart;
    ...
    void Start()
    {
        GameObject Object0 = GameObject.FindWithTag("Kart4");
        Kart = Object0.GetComponent<Kart4>();
    }
    ...
    void FixedUpdate()
    {
        ...
        foreach (Transform child in transform)
        {
            ...
            {
                child2.gameObject.layer = LayerMask.NameToLayer("Kart4");

                foreach (Transform child3 in child2.transform)
                {
                    child3.gameObject.layer = LayerMask.NameToLayer("Kart4");

                    foreach (Transform child4 in child3.transform)
                    {
                        child4.gameObject.layer = LayerMask.NameToLayer("Kart4");
                    }
                }
            }
        }

        ShellAim.layer = LayerMask.NameToLayer("Kart4");
