...
public class Kart2HUD : MonoBehaviour
{
    // Kart Reference
    public Kart2 Kart;
    ...
    void Start()
    {
        GameObject Object0 = GameObject.FindWithTag("Kart2");
        Kart = Object0.GetComponent<Kart2>();
    }
    ...
    void FixedUpdate()
    {
        ...
        foreach (Transform child in transform)
        {
            ...
            {
                child2.gameObject.layer = LayerMask.NameToLayer("Kart2");

                foreach (Transform child3 in child2.transform)
                {
                    child3.gameObject.layer = LayerMask.NameToLayer("Kart2");

                    foreach (Transform child4 in child3.transform)
                    {
                        child4.gameObject.layer = LayerMask.NameToLayer("Kart2");
                    }
                }
            }
        }

        ShellAim.layer = LayerMask.NameToLayer("Kart2");
