...
public static class Pathfinding
{
    ...
    public static List<Node> Pathfind(Algorithm algorithm, Node start, Node end, float heuristicScale)
    {
    ...
    public static List<Node> AStarSearch(Node start, Node end, float heuristicScale)
    {
        // Check if we are missing the start node or end node
        if (start == null || end == null)
        {
    ...
    public static List<Node> BeamSearch(Node start, Node end, int beamWidth)
    {
        // Check if we are missing the start node or end node
        if (start == null || end == null)
        {
