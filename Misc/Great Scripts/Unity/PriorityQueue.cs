...
public class PriorityQueue<DataType>
{
    ...
    public void Enqueue(PriorityQueueElement<DataType> enqueuedNode)
    {
        ...
        foreach (PriorityQueueElement<DataType> Node in Queue)
        {
            if (enqueuedNode.priority < Node.priority)
            {
                ...
                MonoBehaviour.print("Node with a priority of " + enqueuedNode.priority + " was added to the queue. The length of the queue is now " + Queue.Count + ".");
    ...
    public DataType Dequeue()
    {
        ...
        if (Queue.Count == 0)
        {
            MonoBehaviour.print("Queue is empty!");
        ...
        MonoBehaviour.print("Node with a priority of " + dequeuedNode.priority + " was removed from the queue. The length of the queue is now " + Queue.Count + ".");

        if (Queue.Count == 0)
        {
            MonoBehaviour.print("The queue is now empty.");
        }
