...
public static class Array<DataType>
{
    ...
    public static DataType CopyElement(DataType[] array, int index)
    {
        ...
        {
            Debug.LogError("Could not copy element! Index was outside the bounds of the array!");
            return default;
        }
    ...
    public static void Read(DataType[] array)
    {
        ...
        {
            // Array name
            Debug.Log("Array of length " + array.Length + ":    ");
    ...
    public static DataType[] Add(DataType[] array, DataType addedData, int index)
    {
        ...
        {
            Debug.LogError("Could not add! Index was outside the bounds of the array!");
            return array;
        }
    }
    ...
    public static DataType[] AddUnique(DataType[] array, DataType addedData)
    {
        ...
        if (!Contains(array, addedData))
        {
            ...
            Debug.Log("Data added! No matching elements found in the array.");
        ...
        {
            Debug.LogWarning("Did not add! Matching elements found in the array.");
    ...
    public static DataType[] AddDuplicate(DataType[] array, DataType addedData)
    {
        ...
        if (Contains(array, addedData))
        {
            ...
            Debug.Log("Data added! Matching elements found in the array.");
        ...
        {
            Debug.LogWarning("Did not add! No matching elements found in the array.");
    ...
    public static DataType[] Remove(DataType[] array, DataType removedData)
    {
        ...
        Debug.LogError("Could not remove! No matching elements in the array!");
        return array;
    }
    ...
    public static DataType[] Remove(DataType[] array, DataType[] removedData)
    {
        ...
        if (arrayIndex == 0)
        {
            Debug.LogWarning("Could not remove! No matching elements in the array!");
            return array;
        }
    ...
    public static DataType[] Remove(DataType[] array, DataType removedData, int removeAmount)
    {
        ...
        {
            Debug.LogWarning("You cannot remove more elements than the length!");
        }
    ...
    public static DataType[] RemoveIndex(DataType[] array, int removedIndex)
    {
        ...
        {
            Debug.LogError("Could not remove! Index was outside the bounds of the array!");
            return array;
        }
    }
    ...
    public static DataType[] RemoveIndex(DataType[] array, int removedIndex, int removeAmount)
    {
        ...
        {
            Debug.LogError("Could not remove! Index or amount was outside the bounds of the array!");
            return array;
        }
    }
    ...
    public static DataType[] Isolate(DataType[] array, int[] isolatedIndex)
    {
        ...
        {
            Debug.LogError("Could not isolate! Index is longer than array!");
            return array;
        }
    ...
    public static DataType[] Swap(DataType[] array, int swappedIndex1, int swappedIndex2)
    {
        ...
        {
            Debug.LogError("Could not swap! Index was outside the bounds of the array!");
            return array;
        }
    }
    ...
    public static DataType[] Shift(DataType[] array, int shiftAmount)
    {
        ...
        {
            Debug.LogWarning("Shifted array is identical to unshifted array!");
            return array;
        }
    ...
    public static int Find(DataType[] array, DataType data)
    {
        ...
        Debug.LogWarning("Could not find matching data!");
        return -1;
    }
    ...
    public static DataType[] Replace(DataType[] array, int[] index, DataType[] replacement)
    {
        ...
        {
            Debug.LogError("Could not replace! Index and replacement do not have the same length!");
            return array;
        }
    }
    ...
    public static DataType[] Shorten(DataType[] array, int length)
    {
        ...
        {
            Debug.LogError("Could not shorten! Length was outside the bounds of the array!");
            return array;
        }
    }
    ...
    public static DataType[] Slice(DataType[] array, int startingIndex)
    {
        ...
        {
            Debug.LogError("Could not slice! Index was outside the bounds of the array!");
            return array;
        }
    }
    ...
    public static DataType[] Cut(DataType[] array, int startingIndex, int length)
    {
        ...
        {
            Debug.LogError("Could not cut! Length or index was outside the bounds of the array!");
            return array;
        }
    }
    ...
    public static DataType[] Trim(DataType[] array, int trimIndex)
    {
        ...
        {
            Debug.LogError("Could not trim! Index was outside the bounds of the array!");
            return array;
        }
    }
    ...
    public static bool IsEmpty(DataType[] array)
    {
        if (array == null)
        {
            Debug.LogError("Array is null, not empty!");
            return false;
        }
    ...
    public static bool IsDefault(DataType data)
    {
        if (data == null)
        {
            Debug.LogError("Data is null, not empty!");
            return false;
        }
    ...
    public static DataType[] Sort(DataType[] array, int[] order)
    {
        ...
        {
            Debug.LogError("Could not sort! Sorting order length does not match array!");
            return array;
        }
    }
