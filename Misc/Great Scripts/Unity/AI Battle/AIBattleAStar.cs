...
namespace AIBattle
{
    ...
    public static class AStar
    {
        ...
        public static List<Node> Search(Node start, Node end, List<Node> occupiedSpaces = null, Dictionary<Node, float> bombSpaces = null)
        {
            ...
            Dictionary<Node, float> weights = new Dictionary<Node, float>()
        {
            ...
            while (frontier.Queue.Count > 0)
            {
                ...
                if (bombSpaces.ContainsKey(connection))
                {
                    newCost = weights[current] + bombSpaces[connection];
                }
                else
                {
                ...
                if (occupiedSpaces == null || !occupiedSpaces.Contains(connection))
                {
