...
public static class Array<DataType>
{
    ...
    public static DataType CopyElement(DataType[] array, int index)
    {
        ...
        {
            Console.WriteLine("Could not copy element! Index was outside the bounds of the array!");
            return default;
        }
    ...
    public static void Read(DataType[] array)
    {
        ...
        {
            // Array name
            Console.WriteLine("Array of length " + array.Length + ":    ");
    ...
    public static void Read(DataType[] array, bool oneLine)
    {
        ...
        else
        {
            ...
            if (oneLine)
            {
                ...
                // Print log and end
                Console.WriteLine(log + "End of array.");
            }
            else
            {
                // Array name
    ...
    public static DataType[] Add(DataType[] array, DataType addedData, int index)
    {
        ...
        {
            Console.WriteLine("Could not add! Index was outside the bounds of the array!");
            return array;
        }
    }
    ...
    public static DataType[] AddUnique(DataType[] array, DataType addedData)
    {
        ...
        if (!Contains(array, addedData))
        {
            ...
            Console.WriteLine("Data added! No matching elements found in the array.");
        ...
        {
            Console.WriteLine("Did not add! Matching elements found in the array.");
    ...
    public static DataType[] AddDuplicate(DataType[] array, DataType addedData)
    {
        ...
        if (Contains(array, addedData))
        {
            ...
            Console.WriteLine("Data added! Matching elements found in the array.");
        ...
        {
            Console.WriteLine("Did not add! No matching elements found in the array.");
    ...
    public static DataType[] Remove(DataType[] array, DataType removedData)
    {
        ...
        Console.WriteLine("Could not remove! No matching elements in the array!");
        return array;
    }
    ...
    public static DataType[] Remove(DataType[] array, DataType removedData, int removeAmount)
    {
        ...
        {
            Console.WriteLine("You cannot remove more elements than the length!");
        }
    ...
    public static DataType[] RemoveIndex(DataType[] array, int removedIndex)
    {
        ...
        {
            Console.WriteLine("Could not remove! Index was outside the bounds of the array!");
            return array;
        }
    }
    ...
    public static DataType[] RemoveIndex(DataType[] array, int removedIndex, int removeAmount)
    {
        ...
        {
            Console.WriteLine("Could not remove! Index or amount was outside the bounds of the array!");
            return array;
        }
    }
    ...
    public static DataType[] Isolate(DataType[] array, int[] isolatedIndex)
    {
        ...
        {
            Console.WriteLine("Could not isolate! Index is longer than array!");
            return array;
        }
    ...
    public static DataType[] Swap(DataType[] array, int swappedIndex1, int swappedIndex2)
    {
        ...
        {
            Console.WriteLine("Could not swap! Index was outside the bounds of the array!");
            return array;
        }
    }
    ...
    public static DataType[] Shift(DataType[] array, int shiftAmount)
    {
        ...
        {
            Console.WriteLine("Shifted array is identical to unshifted array!");
            return array;
        }
    ...
    public static int Find(DataType[] array, DataType data)
    {
        ...
        Console.WriteLine("Could not find matching data!");
        return -1;
    }
    ...
    public static DataType[] Replace(DataType[] array, int[] index, DataType[] replacement)
    {
        ...
        {
            Console.WriteLine("Could not replace! Index and replacement do not have the same length!");
            return array;
        }
    }
    ...
    public static DataType[] Shorten(DataType[] array, int length)
    {
        ...
        {
            Console.WriteLine("Could not shorten! Length was outside the bounds of the array!");
            return array;
        }
    }
    ...
    public static DataType[] Slice(DataType[] array, int startingIndex)
    {
        ...
        {
            Console.WriteLine("Could not slice! Index was outside the bounds of the array!");
            return array;
        }
    }
    ...
    public static DataType[] Cut(DataType[] array, int startingIndex, int length)
    {
        ...
        {
            Console.WriteLine("Could not cut! Length or index was outside the bounds of the array!");
            return array;
        }
    }
    ...
    public static DataType[] Trim(DataType[] array, int trimIndex)
    {
        ...
        {
            Console.WriteLine("Could not trim! Index was outside the bounds of the array!");
            return array;
        }
    }
    ...
    public static bool IsEmpty(DataType[] array)
    {
        if (array == null)
        {
            Console.WriteLine("Array is null, not empty!");
            return false;
        }
    ...
    public static bool IsDefault(DataType data)
    {
        if (data == null)
        {
            Console.WriteLine("Data is null, not empty!");
            return false;
        }
    ...
    public static DataType[] Sort(DataType[] array, int[] order)
    {
        ...
        {
            Console.WriteLine("Could not sort! Sorting order length does not match array!");
            return array;
        }
    }
